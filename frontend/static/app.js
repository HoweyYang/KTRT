...
const THEME_LABELS = {
  ...
  paper: { light: '宣纸', dark: '绢本', 'dark-blue': '墨玉' },
...
const FEATURE_HINTS = {
  ...
  's-theme': '主题色：随页面质感变化——简约=浅色/深色/石墨，纸质=宣纸/绢本/墨玉，赛博=电光/酸黄/矩阵。',
  'page-normal': '页面质感：简约（Apple / OpenAI 风格，素色、克制留白、细边框）。',
  'page-paper': '页面质感：纸质（宣纸·朱砂 / 绢本·赭石 / 墨玉·泥金，书框版式 + 纸纹纤维 + 楷宋字体）。',
  'page-cyber': '页面质感：科幻（霓虹夜景配色、扫描线、色散标题、DIN 科技字体；三种配色：霓虹夜景 / 酸黄黑 / 矩阵绿）。',
  'theme-light': '配色一号位：简约=浅色，纸质=宣纸（朱砂），科幻=霓虹夜景（青×品红）。',
  'theme-dark': '配色二号位：简约=深色，纸质=绢本（赭石），科幻=酸黄黑。',
  'theme-blue': '配色三号位：简约=石墨，纸质=墨玉（泥金），科幻=矩阵（纯绿黑）。',
};
